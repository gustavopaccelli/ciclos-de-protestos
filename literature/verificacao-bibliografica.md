# Verificação bibliográfica pendente
...
Landis, J. Richard and Koch, Gary G. — *The measurement of observer agreement for categorical data* (1977, article)

- **A nota pede:** dados completos não conferidos em fonte primária nesta sessão
...
Van Evera, Stephen — *Guide to Methods for Students of Political Science* (1997, book)

- **A nota pede:** dados completos não conferidos em fonte primária nesta sessão
- **Campos vazios:** `booktitle`

### `vieira2015conjuntura`

Vieira, Rosângela de Lima — *Como fazer "análise de conjuntura" numa abordagem histórica* (2015, incollection)
